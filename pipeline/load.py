...
if __name__ == "__main__":
    ...
    # LOAD STEP 2: Update the game_publisher_assignment, game_developer_assignment and game_platform assignment
    # Get the current tables and makes them into tuples of (game_id, pub/dev id) to check for duplicates
    ...
    current_game_dev_tuples = lf.make_current_dev_or_pub_game_assignment_tuples(current_game_developer_assignments, 'developer_id')
    current_game_pub_tuples = lf.make_current_dev_or_pub_game_assignment_tuples(current_game_publisher_assignments, 'publisher_id')
    ...
    current_game_platform_tuples = lf.make_current_game_platform_assignment_tuples(current_game_platform_assignments, 'platform_id')
    ...
    new_genre_game_platform_tuples = lf.assign_genre_game_platform(new_games_example,
            game_titles_and_ids, platform_mapping, genres_and_ids,
            current_game_platform_assignments, current_genre_game_platform_tuples)
    new_tag_game_platform_tuples = lf.assign_tag_game_platform(new_games_example,
