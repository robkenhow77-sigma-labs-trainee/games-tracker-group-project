...
from epic_transform import (is_valid_data, is_valid_title, is_valid_genres, is_valid_publisher,
...
neg_price = [None, '100', 'words', datetime.now(), -2.99, "89%", "-10", [], ""]
...
def test_valid_discount_positive(test_input):
    ...
    assert is_valid_discount(test_input, 100) is True


neg_discount = ['words', datetime.now(), -2.99, "50.3", "89%", "-10", "110", [], "", None]
...
def test_valid_discount_negative(test_input):
    ...
    assert is_valid_discount(test_input, 2000) is False
